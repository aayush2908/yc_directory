...
const page = async ({ params }: { params: Promise<{ id: string }>}) => {
    ...
    const parsedContents = md.render(post?.pitch || '');
        ...
        <>
            ...
            <section className="section_container">
                ...
                <div className="space-y-5 mt-10 max-w-4xl mx-auto">
                    ...
                    { parsedContents ? (
                        <article className="prose max-w-4xl font-work-sans break-all" dangerouslySetInnerHTML={{ __html: parsedContents }}/>
                    ):(
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    {topStartups.map((post: StartupTypeCard, i: number) => (
